package de.lmu.cleverecousins.test;

import de.lmu.cleverecousins.protocol.MapLoader;
...
public class MapLoaderTest {
    ...
    private static final Logger logger = Logger.getLogger(de.lmu.test.MapLoaderTest.class.getName());
